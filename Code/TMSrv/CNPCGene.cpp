...
int CNPCGenerator::ParseString(int i, char* str)
{
	...
	else if (!strcmp(str1, "Leader:"))
	{
		...
		BOOL ret = cSrv.ReadMob(&pList[i].Leader, "npc");
	...
	else if (!strcmp(str1, "Follower:"))
	{
		...
		BOOL ret = cSrv.ReadMob(&pList[i].Follower, "npc");
...
void CNPCGenerator::ReadRegion()
{
	...
	while (1)
	{
		char* ret = fgets(tempA, 1023, fp);

		if (ret == NULL)
			break;

		sscanf(tempA, "%d, %d, %d, %d = %s", &pRegion[NumRegion].minX, &pRegion[NumRegion].minY, &pRegion[NumRegion].maxX, &pRegion[NumRegion].maxY, pRegion[NumRegion].RegionName);
...
void CNPCSummon::Initialize()
{
	...
	MobFound = cSrv.ReadMob(&Mob[0], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[1], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[2], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[3], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[4], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[5], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[6], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[7], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[8], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[9], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[10], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[11], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[12], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[13], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[14], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[15], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[16], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[17], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[18], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[19], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[20], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[21], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[22], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[23], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[24], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[25], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[26], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[27], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[28], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[29], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[30], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[31], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[32], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[33], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[34], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[35], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[36], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[37], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[38], "BaseSummon");
	...
	MobFound = cSrv.ReadMob(&Mob[39], "BaseSummon");
